...
// ES5 등장 -> ES6부터 사용됨
//forEach, filter, fine, map, every, some, reduce
...
//filter -Ex2
//users 배열에서 admin 레벨이 true인 유저 object만 filteredUsers라는 배열에 담아서 filteredUsers 배열의 두 번째 유저 이름을 출력해보세요
...
//every
// 배열 내의 모든 요소가 주어진 함수를 통과하는지 테슽하고 결과에 따라 boolean return
...
// find Ex1
// PEOPLE 중에 admin 권할을 가진 요소를 찾아서 admin 상수에 저장해보자!
const PEOPLE = [
  { id:1, admin:false},
  { id:2, admin:false},
  { id:3, admin:true},
]
const admin = PEOPLE.find(ob => ob.admin === true)
console.log(admin)
